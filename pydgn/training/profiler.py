...
class Profiler:
    ...
    :class:`~pydgn.training.event.handler.EventHandler` object implementing a
    ...
    Usage:
        ...
        :class:`~pydgn.training.event.handler.EventHandler` interface
    """
    ...
    def __call__(self, event_handler: EventHandler) -> object:
        r"""
        Wraps a :class:`~pydgn.training.event.handler.EventHandler` object,
        ...
        Args:
            event_handler
                (:class:`~pydgn.training.event.handler.EventHandler`): the
                object implementing a subset of the callbacks defined in
                the :class:`~pydgn.training.event.handler.EventHandler`
                interface
