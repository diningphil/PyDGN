...
class Optimizer(EventHandler):
    ...
    def on_training_epoch_start(self, state):
        """
        At the start of epoch, and if the gradient has been accumulated across the entire epoch,
    ...
    def on_training_epoch_end(self, state):
        """
        At the end of a batch, and if the gradient has been accumulated across the entire epoch,
